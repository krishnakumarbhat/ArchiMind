...
def build_context_payload(embeddings: List[Dict[str, object]]) -> str:
    snippets = []
...
def parse_graph_response(response: str) -> Dict[str, List[Dict[str, object]]]:
    try:
