"""Database models for ArchiMind authentication, history, and rate limiting."""
...
class RepositoryHistory(db.Model):
    """Stores recent repository analyses per user with generated artifacts."""
    ...
    hld_graph = db.Column(db.Text, nullable=True)
    lld_graph = db.Column(db.Text, nullable=True)
